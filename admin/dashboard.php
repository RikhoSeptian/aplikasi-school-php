								...
								<ul class="nav nav-collapse">
									<li>
										<a href="?page=presensi">
											<span class="sub-item">Data Absen</span>
										</a>
									</li>
								</ul>
							</div>
		...
		<div class="main-panel">
			<div class="content">
				...
				if ($page == 'master') {
					...
					if ($act == '') {
						include 'modul/presensi/data_absen.php';
					} else if ($act == 'del') {
						include 'modul/presensi/confirm.php';
					}
				} else if ($page == 'jadwal') {
					if ($act == '') {
			...
			<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y'); ?> SMA KARYA PEMBANGUNAN MARGAHAYU (<a href="https://stmik-mi.ac.id/">STMIK MARDIRA INDONESIA </a> | 2022)
					</div>
				</div>
			</footer>
		</div> 
