          ...
          <form action="?page=siswa&act=proses" method="post" enctype="multipart/form-data">
            ...
            <table cellpadding="3" style="font-weight: bold;">
              <tr>
                ...
                <td>:</td>
                <td>
                  <input name="nis" type="text" class="form-control" value="<?= $d['nis'] ?>" readonly>
                </td>
              </tr>
              <tr>
                <td>Nama Siswa</td>
                <td>:</td>
                <td>
                  <input type="text" class="form-control" name="nama" value="<?= $d['nama_siswa'] ?>">
                </td>
              </tr>
              <tr>
                ...
                <td>:</td>
                <td>
                  <input type="text" class="form-control" name="tempat" value="<?= $d['tempat_lahir'] ?>">
                </td>
              <tr>
                <td></td>
                <td></td>
                <td>
                  <input type="date" class="form-control" name="tgl" value="<?= $d['tgl_lahir'] ?>">
                </td>
              </tr>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>:</td>
                <td>
                  <input name="th_masuk" type="number" class="form-control" value="<?= $d['th_angkatan'] ?>">
                </td>
              </tr>
              <tr>
                <td>Pas Foto</td>
              ...
              <tr>
                <td colspan="3">
                  <button name="editSiswa" type="submit" class="btn btn-primary">
