          ...
          <form action="?page=siswa&act=proses" method="post" enctype="multipart/form-data">
            <table cellpadding="3" style="font-weight: bold;">
              ...
              <tr>
                ...
                <td>:</td>
                <td>
                  <textarea name="alamat" class="form-control" placeholder="Alamat Tinggal Sekaran" required></textarea>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>:</td>
                <td>
                  <input name="th_masuk" type="number" class="form-control" placeholder="2020" required>
                </td>
              </tr>
              <tr>
                <td colspan="3" required>Akun Siswa</td>
              </tr>
              <tr>
                <td>Password</td>
                <td>:</td>
              ...
              <tr>
                <td colspan="3">
                  <button name="saveSiswa" type="submit" class="btn btn-primary">
