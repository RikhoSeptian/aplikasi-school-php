...
<?php
	...
	$sql = mysqli_query($con,"SELECT * FROM tb_guru WHERE id_guru = '$id_login'") or die(mysqli_error($con));
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">	
				<a href="index.php" class="logo">
					...
					<b class="text-white">SMA KP MARGHAYU</b>
				</a>
			...
			<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi SMA KARYA PEMBANGUNAN MARGAHAYU ( <a href="https://stmik-mi.ac.id/">STMIK MARDIRA INDONESIA </a> | 2022 )
					</div>				
				</div>
			</footer>
		</div>
