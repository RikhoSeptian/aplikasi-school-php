...
WHERE tb_mengajar.id_guru='$data[id_guru]' 
AND tb_mengajar.id_mengajar='$_GET[pelajaran]' 
			...
			<div class="card">
				<div class="card-body">
					<div class="card-list">
						...
						<!-- <a href="modul/rekap/rekap_bulan.php?pelajaran=<?= $_GET['pelajaran'] ?>&bulan=<?= $bulan; ?>" class="btn btn-success btn-block text-left" target="_blank">
							<i class=" fas fa-file-alt"></i> BULAN SEKARANG
						</a>
