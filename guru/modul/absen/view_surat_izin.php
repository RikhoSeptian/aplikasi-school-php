...
<div class="col-md-12 mt-3">
	<div class="alert alert-warning alert-dismissible" role="alert">
		...
		<center>
			<div class="avatar">
				<img src="../assets/img/jm_denis.jpg" alt="avatar" class="avatar-img rounded">
			</div>
			<hr>
		</center>
		...
		<p>
			...
			<a target="_blank" href="https://api.whatsapp.com/send?phone=<?= $d['hp_pj']; ?>&text=Permohonan Izin Ananda (<?= $d['nama_siswa']; ?>) 
				<?php
					if ($d['ket_izin'] == '0') {
			...
			<a onclick="return confirm('Yakin akan menolak permohonan ?')" href="?page=absen&act=konfirmasi&id=<?= $d['id_izin']; ?>&persetujuan=No" class="btn btn-danger btn-sm">
