...
<div class="page-inner">
  <div class="page-header">
    ...
    <ul class="breadcrumbs" style="font-weight: bold;">
      ...
      <li class="nav-item">
        <a href="#">Update Absen <?= strtoupper($d['mapel']) ?></a>
      </li>
    </ul>
  </div>
  <div class="row">
    <div class="col-md-8 col-xs-12">
      ...
      ?>
        <!-- <div class="alert alert-danger alert-dismissible" role="alert">
          ...
          <strong class="text-warning">( <?= $si['nama_siswa'] ?> )</strong>
          Mengajukan permintaan izin pada hari ini
          <b>
            <a href="?page=absen&act=surat_view<?= $si['id_izin']; ?>"> Lihat permintaan ?</a>
          </b>
        </div> -->
      <?php } ?>
      ...
      <div class="card">
        <div class="card-body">
          <form action="" method="post">
            ...
            <input type="date" name="tgl" class="form-control bg-warning-gradient" value="<?= date('Y-m-d') ?>" style="background-color: #212121;color: #FFEB3B;">
