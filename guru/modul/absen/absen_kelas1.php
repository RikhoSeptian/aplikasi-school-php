...
<div class="page-inner">
	...
	<div class="row">
      ...
      ?>
          ...
          <b> 
            <a href="?page=absen&act=surat_view&izin=<?= $si['id_izin']; ?>"> 
            Lihat permintaan ?
            </a>
          </b>
				</div>
			...
			<div class="card">
              ...
              ?>
						...
						<center>
							...
							<a href="index.php" class="btn btn-warning btn-block text-left">
                <i class="fas fa-edit"></i> 
                Update Absesnsi
              </a>
							<a href="index.php" class="btn btn-default btn-block text-left">
