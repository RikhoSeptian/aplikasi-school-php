          ...
          <div class="container">
            <div class="page-inner py-5">
              <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                  <h2 class="text-white pb-2 fw-bold">SMA Karya Pembangunan 2 Margahayu</h2>
                  <!-- <h5 class="text-white op-7 mb-2">Absen Lebih mudah gunakan Aplikasi Absensi</h5> -->
                </div>
                <div class="ml-md-auto py-2 py-md-0">
                  <a href="https://goo.gl/maps/TuSmyS7WnMZttrNEA" class="btn btn-white btn-border btn-round mr-2">Jl. Terusan Kopo No.399A, Margahayu, <br>Kabupaten Bandung, Jawa Barat 40226</a>
      ...
      <footer class="footer">
        <div class="container">
          <div class="copyright ml-auto">
            &copy; <?php echo date('Y'); ?> Absensi Siswa SMA KARYA PEMBANGUNAN MARGAHAYU ( <a href="https://stmik-mi.ac.id/">STMIK MARDIRA INDONESIA </a> | 2022 )
          </div>
        </div>
      </footer>
      <!-- footer end -->
